import random
print("This is v1.1.2 of the OPM Monster Generator")
...
#threatNumber: A random number from 1 to 65536. 65536-32768 = TL: Wolf, 32767-16384 = TL: Tiger, 16383-12288 = TL: Demon, 12287-12032 = TL: Dragon, 12031 = TL: God, 12030-1 = No TL
...
while True:
    ...
    if (keypressed=="New") or (keypressed=="Wolf") or (keypressed=="Tiger") or (keypressed=="Demon") or (keypressed=="Dragon") or (keypressed=="God"):
        ...
        if (threatNumber>=32768):
            ...
            threatLevel="Tiger"
        elif (threatNumber<16384) and (threatNumber>=12288):
            threatLevel="Demon"
        elif (threatNumber<12288) and (threatNumber>=12032):
            threatLevel="Dragon"
        elif (threatNumber==12031):
            threatLevel="God"
        elif (threatNumber<12031):
        ...
        if (threatLevel=="None"):
            monsterSpeed = random.randint(10, 60)
            monsterPower = random.randint(10, 60)
            monsterDefense = random.randint(10, 60)
            monsterLevel = round((monsterSpeed+monsterPower+monsterDefense)/3)
        elif (threatLevel=="Wolf"):
            ...
            monsterSpeed = random.randint(15360, 30720)
            monsterPower = random.randint(15360, 30720)
            monsterDefense = random.randint(15360, 30720)
        ...
        print("Threat Level: " ,threatLevel) #prints threat level and stats of monster
